...
\begin{subequations}
    \begin{align}
        \frac{\partial G}{\partial \zeta} &= \frac{1}{\chi} - \frac{\zeta}{\chi^2} \frac{\partial \chi}{\partial \zeta} \nonumber \\
        &= \frac{\chi S - \zeta}{\chi^2 S} \\
        \frac{\partial^2 G}{\partial \zeta^2} &= -\frac{1}{\chi^2} \frac{\partial \chi}{\partial \zeta} - \left(\frac{1}{\chi^2} \frac{\partial \chi}{\partial \zeta} - 2 \frac{\zeta}{\chi^3} \left(\frac{\partial \chi}{\partial \zeta}\right)^2 + \frac{\zeta}{\chi^2} \frac{\partial^2 \chi}{\partial \zeta^2}\right) \nonumber \\
        &= -\frac{2}{\chi^2 S} + \frac{2 \zeta}{\chi^3 S^2} + \frac{\zeta \left(\zeta - \rho\right)}{\chi^2 S^3} \nonumber \\
        &= \frac{\zeta^2 \chi - \rho \chi + 2 \zeta S - 2 \chi S^2}{\chi^3 S^3}
    \end{align}
\end{subequations}
