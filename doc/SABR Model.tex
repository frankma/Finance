...
From model structure and parameters experimentation, we find strong relationships between parameters and the dynamics of the implied volatility surface.
